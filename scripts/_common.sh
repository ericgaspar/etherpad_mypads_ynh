...
# Plugin versions
ep_align_version=0.2.8
ep_author_hover_version=0.3.1
ep_automatic_logut_version=1.0.8
ep_comments_page_version=0.1.8
ep_delete_empty_pads_version=0.0.6
ep_font_color_version=0.0.17
ep_font_size_version=0.4.0
ep_headings2_version=0.1.7
ep_markdown_version=0.1.10
ep_page_view_version=0.5.26
ep_spellcheck_version=0.0.8
ep_subscript_and_superscript_version=0.2.2
ep_table_of_contents_version=0.2.5
